...
import ru.ufanet.servicereference.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().title(DEFAULT_TITLE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().title(UPDATED_TITLE);
        return location;
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.title(UPDATED_TITLE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.title(UPDATED_TITLE);
