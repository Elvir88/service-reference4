...
class ServiceResourceIT {
    ...
    public static Service createEntity(EntityManager em) {
        Service service = new Service().serviceId(DEFAULT_SERVICE_ID).title(DEFAULT_TITLE);
        return service;
    }
    ...
    public static Service createUpdatedEntity(EntityManager em) {
        Service service = new Service().serviceId(UPDATED_SERVICE_ID).title(UPDATED_TITLE);
        return service;
    }
    ...
    void putNewService() throws Exception {
        ...
        updatedService.serviceId(UPDATED_SERVICE_ID).title(UPDATED_TITLE);
    ...
    void fullUpdateServiceWithPatch() throws Exception {
        ...
        partialUpdatedService.serviceId(UPDATED_SERVICE_ID).title(UPDATED_TITLE);
