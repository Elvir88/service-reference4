    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<LocationClass>(LocationUpdateComponent, {
        ...
        provide: {
          ...
          houseService: () =>
            sinon.createStubInstance<HouseService>(HouseService, {
              retrieve: sinon.stub().resolves({}),
            } as any),

          serviceOnLocationService: () =>
            sinon.createStubInstance<ServiceOnLocationService>(ServiceOnLocationService, {
              retrieve: sinon.stub().resolves({}),
            } as any),

          promotionOnLocationService: () =>
            sinon.createStubInstance<PromotionOnLocationService>(PromotionOnLocationService, {
              retrieve: sinon.stub().resolves({}),
            } as any),
        },
      });
